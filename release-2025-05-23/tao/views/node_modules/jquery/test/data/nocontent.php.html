...
<tbody>
    ...
    <tr class="danger d-flex"><td  class="col-1 text-right"><a id="3" href="#3">3</a></td><td class="col-11 codeLine"><span class="default">header</span><span class="keyword">(</span><span class="default">'HTTP/1.0&nbsp;204&nbsp;No&nbsp;Content'</span><span class="keyword">)</span><span class="keyword">;</span></td></tr>
